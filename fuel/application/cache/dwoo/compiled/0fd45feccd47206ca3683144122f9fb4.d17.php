...
<ul id="nav" class="sf_menu">
	<li id="topmenu_3" class="first"><a href="http://local.cms/blog" title="My Blog">My Blog</a></li>
	<li id="topmenu_1"><a href="http://local.cms/test" title="Test">Test</a></li>
	<li id="topmenu_2" class="last active"><a href="http://local.cms/home" title="home page">home page</a></li>
</ul>
        </div>
      </nav>
  <div id="main">
	...
	<div id="content">
		<!--__FUEL_MARKER__4-->Well this is slightly embarassing? I am unable to get the damn page to work properly...

And I am sure that if I keep typing the damn sidebar slips further
and further
and further
down the page	</div>
